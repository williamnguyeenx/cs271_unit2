...
void test_build_min_heap()
{
    ...
    try
    {
        ...
        if (mq_str != "1.5 2.5 4.5 3.5 6.5 5.5 8.5 10.5 7.5 9.5")
        {
            cout << "Incorrect build_heap result from " << mq_str << ". Expected 1.5 2.5 4.5 3.5 6.5 5.5 8.5 10.5 7.5 9.5 but got : " << mq_str << endl;
        }
    }
    catch (exception &e)
    {
...
void test_heapsort()
{
    ...
    {   
        ...
        if (sorted_str != "1.500000 2.500000 3.500000 4.500000 5.500000 6.500000 7.500000 8.500000 9.500000 10.500000")
        {
            cout << "Incorrect heapsort result. Expected 1.500000 2.500000 3.500000 4.500000 5.500000 6.500000 7.500000 8.500000 9.500000 10.500000 but got : " << sorted_str << endl;
        }
    }
    catch (exception &e)
    {
